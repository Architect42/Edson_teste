...
<!--    <div id="Campo_pesquisa">
    ...
    <?php
        ...
        while($res = $sql->fetch_array()){
            ...
            if($color==0){ 
                echo "<tr><td> <input class=No_visible type=submit name=editar value= " . $res['ID_MOT'] . "> <a href=#>ENTRAR</a>"
                    . "</td><td>" . $res['NOME_MOT'] . "</td><td>" . $res['CPF_MOT'] . "</td><td>" . $sexo . "</td><td>" . $res['DATA_NASC_MOT'] . "</td><td>" . $status . "</td></tr></a>";
                $color = 1;
            }else{
                echo "<tr class=dif><td> <input class=No_visible type=submit name=editar value= " . $res['ID_MOT'] . "> <a href=#>ENTRAR</a>"
                    . "</td><td>" . $res['NOME_MOT'] . "</td><td>" . $res['CPF_MOT'] . "</td><td>" . $sexo . "</td><td>" . $res['DATA_NASC_MOT'] . "</td><td>" . $status . "</td></tr>";
                $color = 0;
            }
        }
        echo"</table>";
